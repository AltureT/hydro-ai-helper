...
exports.getBuiltinJailbreakPatterns = exports.getBuiltinJailbreakRules = exports.builtinJailbreakPatternSources = void 0;
...
exports.builtinJailbreakPatternSources = BUILTIN_RULES.map((rule) => rule.pattern.source);
const getBuiltinJailbreakRules = () => BUILTIN_RULES.map((rule) => ({
    ...rule,
    pattern: new RegExp(rule.pattern.source, rule.pattern.flags),
}));
exports.getBuiltinJailbreakRules = getBuiltinJailbreakRules;
const getBuiltinJailbreakPatterns = () => (0, exports.getBuiltinJailbreakRules)().map((rule) => rule.pattern);
