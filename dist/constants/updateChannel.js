...
exports.DEFAULT_UPDATE_CHANNEL = void 0;
exports.getUpdateChannel = getUpdateChannel;
exports.isEdgeChannel = isEdgeChannel;
exports.DEFAULT_UPDATE_CHANNEL = 'stable';
/**
 * 读取当前实例的更新通道
...
function getUpdateChannel() {
    ...
    return exports.DEFAULT_UPDATE_CHANNEL;
}
/**
 * 是否为开发(edge)通道
 */
function isEdgeChannel() {
