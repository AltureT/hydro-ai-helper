...
exports.hasParseableStatementSamples = hasParseableStatementSamples;
...
function hasParseableStatementSamples(statementMarkdown) {
    return extractStatementSamples(statementMarkdown).length > 0;
}
//# sourceMappingURL=statementSamples.js.map