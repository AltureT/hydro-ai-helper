...
export const LOCALE_FALLBACK: Record<'zh' | 'en', Record<string, string>> = {
  "zh": {
    ...
    "ai_helper_testdata_risk_statement_truncated": "题面已截断",
    ...
    "ai_helper_testdata_risk_would_block": "按风险策略将阻止未经验证的直出降级",
  ...
  "en": {
    ...
    "ai_helper_testdata_risk_statement_truncated": "Statement was truncated",
    ...
    "ai_helper_testdata_risk_would_block": "Would block unverified direct fallback",
