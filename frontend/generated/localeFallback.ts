...
export const LOCALE_FALLBACK: Record<'zh' | 'en', Record<string, string>> = {
  "zh": {
    ...
    "ai_helper_testdata_verify_checker_fallback": "题目 checker 编译失败，已按原有跳过策略降级",
  ...
  "en": {
    ...
    "ai_helper_testdata_verify_checker_fallback": "The problem checker failed to compile; existing skip behavior was used",
