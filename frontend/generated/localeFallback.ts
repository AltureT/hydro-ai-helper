...
export const LOCALE_FALLBACK: Record<'zh' | 'en', Record<string, string>> = {
  "zh": {
    ...
    "ai_helper_testdata_err_file_too_large": "文件超过大小上限：输入和回放数据为 4 MiB，输出与代码为 256 KiB",
  ...
  "en": {
    ...
    "ai_helper_testdata_err_file_too_large": "File limit exceeded: inputs and replay data allow 4 MiB; outputs and code allow 256 KiB",
