...
export const LOCALE_FALLBACK: Record<'zh' | 'en', Record<string, string>> = {
  "zh": {
    ...
    "ai_helper_testdata_benchmark_assessment_fail": "当前模型链未达到复杂测试数据生成的建议门槛，不建议直接依赖其生成结果。",
    "ai_helper_testdata_benchmark_assessment_full_pass": "完整基准本轮通过。正式选型建议再运行两轮，确认随机性下仍能稳定通过。",
    "ai_helper_testdata_benchmark_assessment_partial": "模型链存在明显的算法类型短板，请查看失败阶段，考虑更强的首选或后备模型后重试。",
    "ai_helper_testdata_benchmark_assessment_quick_pass": "快速初检已通过；这还不足以证明模型链适合所有难题，建议继续运行完整基准。",
    "ai_helper_testdata_benchmark_assessment_subset_pass": "已选的题目全部通过，但未覆盖完整难题集；正式选型前请继续运行完整基准。",
    ...
    "ai_helper_testdata_benchmark_case_connectivity_purpose": "检查边生命周期、离线时间轴和回滚并查集，容易暴露删除后状态未恢复或区间端点错误。",
    "ai_helper_testdata_benchmark_case_segment": "区间翻转与最长连续 1（懒标记线段树）",
    "ai_helper_testdata_benchmark_case_segment_purpose": "检查懒标记翻转、最长连续段合并与嵌套操作，容易暴露前后缀、局部查询及 0/1 信息维护错误。",
    "ai_helper_testdata_benchmark_case_xor": "子数组异或小于 K（二进制 Trie）",
    "ai_helper_testdata_benchmark_case_xor_purpose": "检查位运算计数、严格小于边界、K=0、高位数与 64 位计数，容易暴露 Trie 查询和 off-by-one 错误。",
    ...
    "ai_helper_testdata_benchmark_confirm_title": "确认运行真实模型基准",
    ...
    "ai_helper_testdata_benchmark_explainer_limit": "PASS 只代表当前这次运行通过固定难题集，不是对所有题目永久正确的保证。重要选型建议完整基准连续运行三轮，真实题目仍需人工复核和标程重测。",
    "ai_helper_testdata_benchmark_explainer_process": "每题要求生成 8 个正式测试点，通过题面样例、VALIDATOR 和 60 组独立小数据压力对拍；最后再用不发送给模型的隐藏探针检查最终标程。",
    "ai_helper_testdata_benchmark_explainer_purpose": "基准用于验收当前已保存的“测试数据生成”模型链，比较模型或提示词升级前后的成功率，并定位解题、独立验证、隐藏探针或沙箱预算阶段的失败。",
    "ai_helper_testdata_benchmark_explainer_title": "展开说明：这个功能有什么用？三道题分别测什么？",
    "ai_helper_testdata_benchmark_failed": "真实模型基准运行失败",
    "ai_helper_testdata_benchmark_mode_custom_hint": "已自定义选择基准题目。",
    "ai_helper_testdata_benchmark_mode_full": "完整基准 · 3 题",
    "ai_helper_testdata_benchmark_mode_full_hint": "同时覆盖边界计数、动态状态回滚和懒标记区间合并，用于正式模型选型。",
    "ai_helper_testdata_benchmark_mode_quick": "快速验证 · 1 题",
    "ai_helper_testdata_benchmark_mode_quick_hint": "适合刚配置完成时的低成本初检；通过后仍应运行完整基准。",
    "ai_helper_testdata_benchmark_mode_title": "选择验证模式",
    "ai_helper_testdata_benchmark_model_chain_empty": "尚未选择模型",
    "ai_helper_testdata_benchmark_model_chain_global": "“测试数据生成”尚未设置专属链，当前会跟随全局模型链。",
    "ai_helper_testdata_benchmark_model_chain_label": "当前页面中的评估对象",
    "ai_helper_testdata_benchmark_no_result": "基准进度流结束，但未收到最终报告",
    "ai_helper_testdata_benchmark_not_ready": "请先完成模型配置、保存并通过沙箱就绪检查",
    "ai_helper_testdata_benchmark_onboarding_action": "查看使用引导",
    "ai_helper_testdata_benchmark_onboarding_desc": "请先为“测试数据生成”场景配置模型链，再通过免费就绪检查和难题基准判断它是否适合生成复杂题数据。",
    "ai_helper_testdata_benchmark_onboarding_dismiss": "知道了",
    "ai_helper_testdata_benchmark_onboarding_title": "新功能：先验证复杂测试数据生成模型",
    "ai_helper_testdata_benchmark_open_settings": "去配置模型",
    ...
    "ai_helper_testdata_benchmark_readiness_configured": "已配置",
    "ai_helper_testdata_benchmark_readiness_failed": "就绪检查请求失败：{0}",
    "ai_helper_testdata_benchmark_readiness_fallback": "后备模型",
    "ai_helper_testdata_benchmark_readiness_missing": "未配置",
    "ai_helper_testdata_benchmark_readiness_model": "已保存的模型配置",
    "ai_helper_testdata_benchmark_readiness_ready": "已就绪",
    "ai_helper_testdata_benchmark_readiness_recheck": "重新检查",
    "ai_helper_testdata_benchmark_readiness_recommended": "建议配置",
    "ai_helper_testdata_benchmark_readiness_sandbox": "Hydro go-judge 沙箱",
    "ai_helper_testdata_benchmark_readiness_saved": "当前页面修改",
    "ai_helper_testdata_benchmark_readiness_title": "运行前就绪检查（不调用付费模型）",
    "ai_helper_testdata_benchmark_readiness_unavailable": "不可用",
    "ai_helper_testdata_benchmark_readiness_unsaved": "尚未保存",
    "ai_helper_testdata_benchmark_run": "运行真实模型基准",
    "ai_helper_testdata_benchmark_run_full_next": "切换到完整基准",
  ...
  "en": {
    ...
    "ai_helper_testdata_benchmark_assessment_fail": "The current model chain does not meet the recommended threshold for complex test-data generation; do not rely directly on its output.",
    "ai_helper_testdata_benchmark_assessment_full_pass": "This full run passed. For formal selection, run two more rounds to confirm stability under model randomness.",
    "ai_helper_testdata_benchmark_assessment_partial": "The chain has a clear weakness for at least one algorithm type. Review the failure stage and retry with a stronger primary or fallback model.",
    "ai_helper_testdata_benchmark_assessment_quick_pass": "The quick check passed, but this is not enough to prove the chain is suitable for every hard problem. Continue with the full benchmark.",
    "ai_helper_testdata_benchmark_assessment_subset_pass": "Every selected case passed, but the full hard set was not covered. Run the full benchmark before formal model selection.",
    ...
    "ai_helper_testdata_benchmark_case_connectivity_purpose": "Checks edge lifetimes, offline time intervals, and rollback DSU state; it exposes failed rollback and interval-boundary errors.",
    "ai_helper_testdata_benchmark_case_segment": "Range flips and longest run of ones (lazy segment tree)",
    "ai_helper_testdata_benchmark_case_segment_purpose": "Checks lazy range flips, longest-run merging, and nested operations; it exposes prefix/suffix, partial-query, and zero/one state errors.",
    "ai_helper_testdata_benchmark_case_xor": "Subarray XOR less than K (binary trie)",
    "ai_helper_testdata_benchmark_case_xor_purpose": "Checks bitwise counting, strict less-than boundaries, K=0, high bits, and 64-bit counts; it exposes trie-query and off-by-one errors.",
    ...
    "ai_helper_testdata_benchmark_confirm_title": "Confirm live-model benchmark",
    ...
    "ai_helper_testdata_benchmark_explainer_limit": "PASS means only that this run passed the fixed hard set; it is not a permanent guarantee for every problem. For important model selection, run the full benchmark three times, and still review and rejudge real problems with the reference solution.",
    "ai_helper_testdata_benchmark_explainer_process": "Each case must produce 8 formal tests and pass statement samples, the validator, and 60 independent small-case stress comparisons. Model-hidden probes then check the final reference solution.",
    "ai_helper_testdata_benchmark_explainer_purpose": "The benchmark validates the currently saved Test Data Generation model chain, compares model or prompt changes, and identifies failures in solution design, independent verification, hidden probes, or sandbox budgeting.",
    "ai_helper_testdata_benchmark_explainer_title": "Learn more: what does this do, and what do the three cases test?",
    "ai_helper_testdata_benchmark_failed": "The live-model benchmark failed",
    "ai_helper_testdata_benchmark_mode_custom_hint": "A custom subset of benchmark cases is selected.",
    "ai_helper_testdata_benchmark_mode_full": "Full benchmark · 3 cases",
    "ai_helper_testdata_benchmark_mode_full_hint": "Covers boundary counting, dynamic rollback state, and lazy range merging for formal model selection.",
    "ai_helper_testdata_benchmark_mode_quick": "Quick check · 1 case",
    "ai_helper_testdata_benchmark_mode_quick_hint": "A lower-cost first check after configuration. Run the full benchmark after it passes.",
    "ai_helper_testdata_benchmark_mode_title": "Choose a validation mode",
    "ai_helper_testdata_benchmark_model_chain_empty": "No model selected",
    "ai_helper_testdata_benchmark_model_chain_global": "Test Data Generation has no dedicated chain and currently follows the global model chain.",
    "ai_helper_testdata_benchmark_model_chain_label": "Evaluation target shown on this page",
    "ai_helper_testdata_benchmark_no_result": "The benchmark progress stream ended without a final report",
    "ai_helper_testdata_benchmark_not_ready": "Configure and save the model chain, then pass the sandbox readiness check before running",
    "ai_helper_testdata_benchmark_onboarding_action": "View usage guide",
    "ai_helper_testdata_benchmark_onboarding_desc": "Configure a model chain for Test Data Generation, then use the free readiness check and hard-problem benchmark to judge whether it is suitable for complex problems.",
    "ai_helper_testdata_benchmark_onboarding_dismiss": "Got it",
    "ai_helper_testdata_benchmark_onboarding_title": "New: validate the model used for difficult test-data generation",
    "ai_helper_testdata_benchmark_open_settings": "Configure models",
    ...
    "ai_helper_testdata_benchmark_readiness_configured": "Configured",
    "ai_helper_testdata_benchmark_readiness_failed": "Readiness check failed: {0}",
    "ai_helper_testdata_benchmark_readiness_fallback": "Fallback model",
    "ai_helper_testdata_benchmark_readiness_missing": "Not configured",
    "ai_helper_testdata_benchmark_readiness_model": "Saved model configuration",
    "ai_helper_testdata_benchmark_readiness_ready": "Ready",
    "ai_helper_testdata_benchmark_readiness_recheck": "Check again",
    "ai_helper_testdata_benchmark_readiness_recommended": "Recommended",
    "ai_helper_testdata_benchmark_readiness_sandbox": "Hydro go-judge sandbox",
    "ai_helper_testdata_benchmark_readiness_saved": "Current page changes",
    "ai_helper_testdata_benchmark_readiness_title": "Pre-run readiness check (no paid-model calls)",
    "ai_helper_testdata_benchmark_readiness_unavailable": "Unavailable",
    "ai_helper_testdata_benchmark_readiness_unsaved": "Not saved",
    "ai_helper_testdata_benchmark_run": "Run live-model benchmark",
    "ai_helper_testdata_benchmark_run_full_next": "Switch to full benchmark",
