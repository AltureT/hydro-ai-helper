...
export const LOCALE_FALLBACK: Record<'zh' | 'en', Record<string, string>> = {
  "zh": {
    ...
    "ai_helper_admin_testdata_role_adjudicator_purpose": "处理解析或验证中的分歧，需要结合证据判断。",
    "ai_helper_admin_testdata_role_artifacts": "生成器与配套文件",
    "ai_helper_admin_testdata_role_artifacts_purpose": "按约束生成数据、校验器与配套文件，可先试 Flash，并用 Pro 兜底。",
    ...
    "ai_helper_admin_testdata_role_spec_critic_purpose": "对照题面检查主解析的遗漏，需要独立发现约束错误。",
    ...
    "ai_helper_admin_testdata_role_verifier_purpose": "独立检查答案与程序，需要发现错误算法及边界问题。",
  ...
  "en": {
    ...
    "ai_helper_admin_testdata_role_adjudicator_purpose": "Resolve disagreements in parsing or verification; requires reasoning from the evidence.",
    "ai_helper_admin_testdata_role_artifacts": "Generator and supporting files",
    "ai_helper_admin_testdata_role_artifacts_purpose": "Generate data, validators and supporting files within the constraints; try Flash with Pro as fallback.",
    ...
    "ai_helper_admin_testdata_role_spec_critic_purpose": "Check the primary spec against the statement; requires independently spotting missed or incorrect constraints.",
    ...
    "ai_helper_admin_testdata_role_verifier_purpose": "Independently check answers and programs; requires detecting incorrect algorithms and boundary failures.",
