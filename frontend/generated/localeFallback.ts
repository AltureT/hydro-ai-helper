...
export const LOCALE_FALLBACK: Record<'zh' | 'en', Record<string, string>> = {
  "zh": {
    ...
    "ai_helper_admin_scenario_testdata_strong_model_warning": "⚠️ 正确性优先：建议为此场景指定思考能力更深、代码推理更稳定的模型。能力不足时，生成器与标程容易自相矛盾并反复卡在沙箱验证。",
  ...
  "en": {
    ...
    "ai_helper_admin_scenario_testdata_strong_model_warning": "⚠️ Correctness first: assign a model with deeper reasoning and reliable code generation to this scenario. Insufficient capability often produces contradictory generators and reference solutions that repeatedly fail sandbox verification.",
