...
export const LOCALE_FALLBACK: Record<'zh' | 'en', Record<string, string>> = {
  "zh": {
    ...
    "ai_helper_admin_model_down": "下移",
    "ai_helper_admin_model_remove": "移除",
    "ai_helper_admin_model_up": "上移",
    ...
    "ai_helper_admin_scenario_desc": "各功能默认使用全局模型。需要不同模型时，在对应功能下单独设置；模型按所列顺序调用。",
    ...
    "ai_helper_admin_scenario_testdata_strong_model_warning": "模型选择建议：优先使用代码推理稳定的模型，可添加能力更强的备选模型处理较难题目。",
    ...
    "ai_helper_admin_testdata_recommend_flash": "建议 DeepSeek Flash",
    "ai_helper_admin_testdata_recommend_flash_fallback": "建议 Flash，Pro 备用",
    "ai_helper_admin_testdata_recommend_pro": "建议 DeepSeek Pro",
    "ai_helper_admin_testdata_role_add_model": "添加模型…",
    "ai_helper_admin_testdata_role_adjudicator": "冲突裁决",
    "ai_helper_admin_testdata_role_adjudicator_purpose": "两份题意规范有冲突时，依据题面证据裁决。",
    "ai_helper_admin_testdata_role_artifacts": "生成器与配套文件",
    "ai_helper_admin_testdata_role_artifacts_purpose": "生成输入生成器或生成计划，以及函数题模板，可先试 Flash，并用 Pro 兜底。",
    "ai_helper_admin_testdata_role_configure": "配置",
    "ai_helper_admin_testdata_role_inherited": "跟随测试数据生成设置",
    "ai_helper_admin_testdata_role_no_model": "尚未配置模型",
    "ai_helper_admin_testdata_role_oracle": "标准答案",
    "ai_helper_admin_testdata_role_oracle_purpose": "编写用于计算正确答案的程序，需要算法与代码推理能力。",
    "ai_helper_admin_testdata_role_reset": "恢复跟随测试数据生成",
    "ai_helper_admin_testdata_role_spec_critic": "题意独立复核",
    "ai_helper_admin_testdata_role_spec_critic_purpose": "独立核对题意。请与题意主解析使用不同模型，备用模型也不要重叠。",
    "ai_helper_admin_testdata_role_spec_primary": "题意主解析",
    "ai_helper_admin_testdata_role_spec_primary_purpose": "提取输入格式、约束与边界，需要稳定理解题意。",
    "ai_helper_admin_testdata_role_verifier": "独立验证",
    "ai_helper_admin_testdata_role_verifier_purpose": "独立核对答案与输入。请与标准答案使用不同模型，备用模型也不要重叠。",
    "ai_helper_admin_testdata_roles_desc": "默认沿用测试数据生成模型。点开阶段可修改，模型按顺序尝试。以下建议仅供试配，请先用已知答案的题目验证。",
    "ai_helper_admin_testdata_roles_title": "按阶段配置模型（高级）",
    ...
    "ai_helper_batch_summary_action_failed": "操作未完成，请重试。",
    "ai_helper_batch_summary_awaiting_review": "待审阅草稿",
    ...
    "ai_helper_batch_summary_generated_count": "已生成 {0} / {1} 份",
    "ai_helper_batch_summary_generating": "正在生成 AI 总结...",
    "ai_helper_batch_summary_loading": "加载中...",
    "ai_helper_batch_summary_more_actions": "更多生成操作",
    ...
    "ai_helper_batch_summary_remaining_count": "待生成 {0} 份",
    ...
    "ai_helper_next_page": "下一页",
    "ai_helper_previous_page": "上一页",
    ...
    "ai_helper_teaching_summary_copy_student": "复制学生版",
    "ai_helper_teaching_summary_evidence_label": "依据",
    "ai_helper_teaching_summary_evidence_title": "查看问题依据与学生名单",
    "ai_helper_teaching_summary_failure_hint": "未能取得完整的分析结果，请稍后重试。",
    "ai_helper_teaching_summary_failure_title": "本次教学分析未完成",
    "ai_helper_teaching_summary_focus_hint": "根据本次学习数据生成，原因请结合课堂观察核实。",
    "ai_helper_teaching_summary_focus_title": "本次教学重点",
    "ai_helper_teaching_summary_high_priority": "优先关注",
    "ai_helper_teaching_summary_homework_audience": "练习查看版本",
    "ai_helper_teaching_summary_homework_student": "学生练习",
    "ai_helper_teaching_summary_homework_teacher": "教师参考",
    "ai_helper_teaching_summary_homework_unrecognized": "这份作业的格式无法可靠区分学生练习和教师答案。请在教师参考中检查并手动整理，暂不支持一键复制。",
    "ai_helper_teaching_summary_individual_support": "个别支持建议",
    "ai_helper_teaching_summary_priority_attention": "建议优先关注",
    "ai_helper_teaching_summary_retry": "重试生成",
    "ai_helper_teaching_summary_retry_hint": "可以再次尝试生成；若持续失败，请联系管理员检查 AI 服务。",
    "ai_helper_teaching_summary_section_homework": "课后巩固练习",
    "ai_helper_teaching_summary_section_review": "下节课怎么讲",
    "ai_helper_teaching_summary_student_hint": "包含练习代码和变式思考，复制内容与下方学生版一致。",
    "ai_helper_teaching_summary_teacher_hint": "包含练习目的与参考答案，供教师备课查看。“复制学生版”只复制学生练习。",
    "ai_helper_teaching_summary_view_details": "查看详情",
    "ai_helper_teaching_summary_view_teacher": "查看教师参考",
    "ai_helper_testdata_apply_btn": "写入题目（{0} 个文件）",
    ...
    "ai_helper_testdata_background_active": "任务在后台运行，可离开本页面；返回题目文件页时会自动恢复进度和结果。",
    ...
    "ai_helper_testdata_coverage_case": "测试点 {0}",
    "ai_helper_testdata_coverage_plan_hint": "以下是计划覆盖的情况，请结合文件内容核对。",
    "ai_helper_testdata_coverage_scale_large": "接近上限",
    "ai_helper_testdata_coverage_scale_medium": "中等规模",
    "ai_helper_testdata_coverage_scale_small": "小规模",
    ...
    "ai_helper_testdata_direct_confirmation_action": "确认未经验证的直出生成",
    "ai_helper_testdata_direct_confirmation_required": "此中风险题目只有再次确认后才能使用未经验证的直出生成。",
    "ai_helper_testdata_discard_btn": "放弃本次结果",
    "ai_helper_testdata_discard_confirm": "确认放弃本次生成结果？此操作不会写入任何文件。",
    "ai_helper_testdata_discrimination_summary": "区分度验证：已卡住 {0}/{1} 个靶子",
    "ai_helper_testdata_discrimination_warning": "仍有靶子未被卡住或未完成验证，请查看生成说明并人工复核",
    "ai_helper_testdata_edit_file": "编辑 {0}",
    ...
    "ai_helper_testdata_err_config_unparsable": "现有 config.yaml 无法解析，为避免覆盖丢失配置已中止；请先修复或删除该文件后重试",
    "ai_helper_testdata_err_cpp_oracle_infra": "C++ 编译基础设施暂时不可用，无法执行教师提供的 C++ 标准答案；请稍后重试或检查沙箱服务",
    "ai_helper_testdata_err_cpp_oracle_unavailable": "当前沙箱无 C++ 编译能力，无法使用教师提供的 C++ 标准答案；请检查 g++ 配置或改用 Python 标程",
    "ai_helper_testdata_err_cpp_std_compile_failed": "教师提供的 C++ 标准答案编译失败；g++ 错误摘要：",
    ...
    "ai_helper_testdata_err_file_too_large": "文件超过大小上限：输入、输出和回放数据为 4 MiB，代码为 256 KiB",
    ...
    "ai_helper_testdata_err_total_too_large": "文件总大小超过 8 MiB 上限",
    ...
    "ai_helper_testdata_failure_brute_runtime_failed": "独立暴力解运行失败，无法完成对拍",
    "ai_helper_testdata_failure_brute_timeout": "独立暴力解在小数据上超时，无法完成可靠对拍",
    "ai_helper_testdata_failure_cancelled": "已取消本次生成；已经发出的模型请求仍可能产生费用",
    "ai_helper_testdata_failure_checker_compile_failed": "题目 checker 编译失败",
    "ai_helper_testdata_failure_checker_required_unavailable": "题目需要 checker 验证，但 checker 当前不可用",
    "ai_helper_testdata_failure_checker_runtime_failed": "题目 checker 运行失败或基础设施异常",
    "ai_helper_testdata_failure_coverage_requirement_missing": "测试数据未满足必要的覆盖要求",
    "ai_helper_testdata_failure_direct_fallback_confirmation_required": "此中风险题目需教师再次确认，才可使用未经验证的直出生成",
    "ai_helper_testdata_failure_generator_invalid_input": "输入生成器产生了不合法的测试输入",
    "ai_helper_testdata_failure_generator_invalid_json": "输入生成器返回了无效数据格式，自动生成已停止",
    "ai_helper_testdata_failure_generator_output_too_large": "输入生成器产出的内容超过安全大小限制",
    "ai_helper_testdata_failure_generator_wrong_case_count": "输入生成器返回的测试点数量不符合要求",
    "ai_helper_testdata_failure_mutation_score_too_low": "测试数据对典型错误解的区分能力不足",
    "ai_helper_testdata_failure_oracle_brute_divergence": "标程与独立暴力解结果不一致，已停止自动修复并等待裁决",
    "ai_helper_testdata_failure_oracle_compile_failed": "标程编译失败，无法继续机器验证",
    "ai_helper_testdata_failure_oracle_runtime_failed": "标程运行失败，无法生成可靠输出",
    "ai_helper_testdata_failure_oracle_sample_mismatch": "标程未通过题面样例验证",
    "ai_helper_testdata_failure_pipeline_budget_exhausted": "机器验证已达到总时长上限；请减少测试点数量或降低数据规模后重试",
    "ai_helper_testdata_failure_sandbox_required": "此生成任务必须使用 Hydro 沙箱验证",
    "ai_helper_testdata_failure_sandbox_unavailable": "Hydro 沙箱当前不可用，请稍后重试或检查服务配置",
    "ai_helper_testdata_failure_spec_conflict": "不同题意分析结果存在冲突，需要进一步裁决",
    "ai_helper_testdata_failure_spec_consensus_required": "题意尚未达成可靠共识，需要进一步确认",
    "ai_helper_testdata_failure_spec_evidence_not_found": "题意分析缺少可核对的题面依据，已停止生成",
    "ai_helper_testdata_failure_spec_parse_failed": "题意解析失败；请重试或检查题面格式",
    "ai_helper_testdata_failure_spec_statement_too_long": "题面过长，当前流程无法安全解析；请缩短题面或稍后重试",
    "ai_helper_testdata_failure_spec_statement_truncated": "题面未被完整处理，已停止生成以避免遗漏约束",
    "ai_helper_testdata_failure_stress_insufficient_valid_inputs": "通过校验的压力数据不足，无法继续可靠对拍",
    "ai_helper_testdata_failure_stress_low_diversity": "压力数据重复过多，无法形成有效验证",
    "ai_helper_testdata_failure_subtask_constraint_violation": "生成数据违反了子任务约束",
    "ai_helper_testdata_failure_template_compile_failed": "评测模板编译失败",
    "ai_helper_testdata_failure_template_output_mismatch": "评测模板输出与标程不一致",
    "ai_helper_testdata_failure_template_runtime_failed": "评测模板运行失败",
    "ai_helper_testdata_failure_trusted_solutions_diverged": "候选标程与独立验证结果冲突，已拒绝自动采用",
    "ai_helper_testdata_failure_unknown": "测试数据生成未通过机器验证，请重试或使用骨架模式",
    "ai_helper_testdata_failure_validator_constraint_coverage_missing": "输入校验器未覆盖全部必要约束",
    "ai_helper_testdata_failure_validator_false_accept": "输入校验器接受了不合法数据，需要修正校验规则",
    "ai_helper_testdata_failure_validator_false_reject": "输入校验器拒绝了应参与验证的数据，需要修正校验器或生成器",
    "ai_helper_testdata_fallback_suggestion": "若 AI 服务持续不可用，可先用「生成骨架文件（不调用 AI）」得到评测配置与模板骨架，手动填写测试数据。",
    "ai_helper_testdata_files_title": "查看与编辑文件",
    "ai_helper_testdata_fill_in_auto": "自动判断（根据题面）",
    "ai_helper_testdata_fill_in_detected": "已检测到题面疑似包含待完善代码。填空题的标程与测试数据输出将严格匹配题面代码的打印格式。",
    "ai_helper_testdata_fill_in_hint": "按题面待完善代码的输出格式生成答案。",
    ...
    "ai_helper_testdata_generating_hint": "复杂题目可能需要数分钟以上，期间的模型调用会持续产生费用；可随时取消。",
    "ai_helper_testdata_job_failed": "后台生成任务失败，请重试",
    "ai_helper_testdata_job_interrupted": "生成服务在任务执行期间重启或失去连接。可从已保存的断点继续；若参数或题面已变化，系统会自动改为全新生成。",
    ...
    "ai_helper_testdata_kill_targets_capped_warning": "模型返回了 {0} 个错误解靶子；服务端仅保留前 {1} 个。",
    ...
    "ai_helper_testdata_kind_hint": "函数题会同时生成评测模板；特殊输入格式可在补充要求中说明。",
    "ai_helper_testdata_kind_input": "测试输入",
    "ai_helper_testdata_kind_label": "题目类型",
    "ai_helper_testdata_kind_output": "预期输出",
    "ai_helper_testdata_kind_std": "参考标程",
    "ai_helper_testdata_kind_template": "评测模板",
    "ai_helper_testdata_kind_traditional": "传统题（标准输入输出）",
    "ai_helper_testdata_languages_hint": "选择需要支持的语言，仅函数题生效。",
    "ai_helper_testdata_languages_label": "函数题模板语言",
    "ai_helper_testdata_manual_review_suggestion": "该失败需要人工裁决或复核。继续前请检查冲突制品与沙箱验证证据。",
    "ai_helper_testdata_mutation_generated": "生成候选",
    "ai_helper_testdata_mutation_historical": "历史候选",
    "ai_helper_testdata_mutation_killed": "已检出",
    "ai_helper_testdata_mutation_mode": "门禁",
    "ai_helper_testdata_mutation_mode_enforce": "强制",
    "ai_helper_testdata_mutation_mode_observe": "观察",
    "ai_helper_testdata_mutation_mode_off": "关闭",
    "ai_helper_testdata_mutation_operator_arithmetic_operator": "算术运算符",
    "ai_helper_testdata_mutation_operator_comparison_boundary": "边界比较",
    "ai_helper_testdata_mutation_operator_constant_off_by_one": "常量 ±1",
    "ai_helper_testdata_mutation_operator_equality_negation": "等值取反",
    "ai_helper_testdata_mutation_operator_historical_submission": "历史错误提交",
    "ai_helper_testdata_mutation_operator_logical_connector": "逻辑连接符",
    "ai_helper_testdata_mutation_operators": "变异算子",
    "ai_helper_testdata_mutation_skip_budget_exhausted": "预算已耗尽",
    "ai_helper_testdata_mutation_skip_checker_infra": "Checker 基础设施不可用",
    "ai_helper_testdata_mutation_skip_gate_off": "门禁已关闭",
    "ai_helper_testdata_mutation_skip_no_candidates": "没有候选",
    "ai_helper_testdata_mutation_skip_no_viable_candidates": "没有有效候选",
    "ai_helper_testdata_mutation_skip_reason": "原因",
    "ai_helper_testdata_mutation_skip_sandbox_infra": "沙箱基础设施不可用",
    "ai_helper_testdata_mutation_skip_sandbox_unavailable": "沙箱不可用",
    "ai_helper_testdata_mutation_skip_unsupported_source": "源码语言不受支持",
    "ai_helper_testdata_mutation_status": "状态",
    "ai_helper_testdata_mutation_status_completed": "已完成",
    "ai_helper_testdata_mutation_status_partial": "部分完成",
    "ai_helper_testdata_mutation_status_skipped": "已跳过",
    "ai_helper_testdata_mutation_survived": "未检出",
    "ai_helper_testdata_mutation_title": "变异测试证据",
    "ai_helper_testdata_mutation_unavailable": "不可用",
    "ai_helper_testdata_mutation_viable": "有效候选",
    "ai_helper_testdata_notes_ai_toggle": "AI 生成说明(点击展开)",
    "ai_helper_testdata_notes_system_title": "验证说明",
    "ai_helper_testdata_notes_warnings_title": "需要注意",
    "ai_helper_testdata_outcome_already_recorded": "本次结果已记录最终处理方式，不能重复提交",
    "ai_helper_testdata_outcome_invalid_reason": "放弃原因无效",
    "ai_helper_testdata_overwrite_badge": "覆盖",
    "ai_helper_testdata_overwrite_hint": "题目中已存在同名文件，写入后将被覆盖",
    "ai_helper_testdata_panel_subtitle": "根据题面生成测试数据，确认后写入题目。",
    "ai_helper_testdata_panel_title": "AI 生成测试数据",
    "ai_helper_testdata_progress_artifacts": "正在生成数据生成器与独立校验组件",
    "ai_helper_testdata_progress_assembling": "验证通过，正在组装文件计划",
    "ai_helper_testdata_progress_attempt": "第 {0} 轮完整生成",
    "ai_helper_testdata_progress_blueprint": "正在分析题目并设计解法",
    "ai_helper_testdata_progress_blueprint_repair": "正在修正解法输出格式",
    "ai_helper_testdata_progress_checking_templates": "正在实跑函数题模板",
    "ai_helper_testdata_progress_complete": "测试数据生成完成",
    "ai_helper_testdata_progress_discrimination_testing": "正在验证数据能否卡住典型错误解",
    "ai_helper_testdata_progress_elapsed": "已等待 {0}:{1}",
    "ai_helper_testdata_progress_generating_inputs": "正在沙箱生成正式与压力输入",
    "ai_helper_testdata_progress_heartbeat": "后台任务运行中 · {0} 秒前有响应",
    "ai_helper_testdata_progress_heartbeat_stale": "后台任务暂时没有响应，页面正在继续查询；请勿重复启动新任务。",
    "ai_helper_testdata_progress_independent_verifier": "AI 正在独立生成暴力解与压力数据",
    "ai_helper_testdata_progress_last_update": "上次进度更新于 {0}:{1} 前",
    "ai_helper_testdata_progress_live": "实际执行阶段",
    ...
    "ai_helper_testdata_progress_waiting_long": "当前阶段耗时较长，任务仍在正常运行；可以继续等待，也可以随时取消。",
    "ai_helper_testdata_refresh_btn": "刷新页面",
    "ai_helper_testdata_regenerate_btn": "重新生成",
    "ai_helper_testdata_result_checked": "自动检查已完成",
    "ai_helper_testdata_result_not_written": "尚未写入题目",
    "ai_helper_testdata_result_partly_written": "已有文件写入，请核对后再写入",
    "ai_helper_testdata_result_review": "写入前请核对",
    "ai_helper_testdata_result_review_answers": "答案核对发现不一致，请修正后再写入。",
    "ai_helper_testdata_result_review_config": "请在评测配置（config.yaml）中核对所有测试点的子任务归属与分值；未纳入子任务的测试点不会参与评测。",
    "ai_helper_testdata_result_review_coverage": "部分关键边界覆盖不足，请补充对应测试点。",
    "ai_helper_testdata_result_review_direct": "答案尚未实际运行验证，请先用正确解法核对。",
    "ai_helper_testdata_result_review_files": "评测模板或判题程序未通过检查，请修正后再写入。",
    "ai_helper_testdata_result_review_incomplete": "部分检查未通过或尚未完成，请核对题意与关键测试点。",
    "ai_helper_testdata_result_review_inputs": "输入范围检查不完整或发现异常，请核对数据是否符合题目要求。",
    "ai_helper_testdata_result_review_next": "请抽查输入与答案，写入后提交正确解法重测。",
    "ai_helper_testdata_result_review_skeleton": "请填写每个测试点的输入与答案，空白文件还不能用于评测。",
    "ai_helper_testdata_result_review_skeleton_function": "请填写输入与答案，并补全评测模板中的 TODO 后再写入。",
    "ai_helper_testdata_result_review_statement": "题意理解仍有分歧，请核对输入要求和答案规则。",
    "ai_helper_testdata_result_skeleton_title": "已准备 {0} 个空白测试点",
    "ai_helper_testdata_result_title": "已生成 {0} 个测试点",
    "ai_helper_testdata_resume_checkpoint_btn": "从断点恢复",
    "ai_helper_testdata_retry_btn": "重试",
    "ai_helper_testdata_retry_suggestion": "该失败制品可以修复。请核对错误信息后重新生成。",
    "ai_helper_testdata_review_warning": "输入生成器和参考标程由 AI 编写；沙箱会实际运行标程生成 .out，但标程算法仍可能有误。请核对关键测试点，写入后建议提交标程并重测整题。",
    "ai_helper_testdata_risk_complex_structure": "复杂嵌套结构",
    "ai_helper_testdata_risk_counted_test_cases": "计数多测试用例",
    "ai_helper_testdata_risk_custom_checker": "自定义 checker",
    "ai_helper_testdata_risk_direct_allowed": "允许直出降级",
    "ai_helper_testdata_risk_floating_point": "浮点输出",
    "ai_helper_testdata_risk_graph_or_tree": "图或树结构",
    "ai_helper_testdata_risk_mode": "可靠性模式",
    "ai_helper_testdata_risk_multiple_guarantees_or_conventions": "多个保证或约定",
    "ai_helper_testdata_risk_multiple_valid_output": "多种合法输出",
    "ai_helper_testdata_risk_no": "否",
    "ai_helper_testdata_risk_no_parseable_samples": "无可解析样例对",
    "ai_helper_testdata_risk_requires_consensus": "要求题意共识",
    "ai_helper_testdata_risk_requires_independent_models": "要求独立模型",
    "ai_helper_testdata_risk_requires_sandbox": "要求沙箱",
    "ai_helper_testdata_risk_spec_conflict": "题意规格冲突",
    "ai_helper_testdata_risk_stateful_operations": "状态修改操作",
    "ai_helper_testdata_risk_statement_too_long": "题面超过安全审阅阈值",
    "ai_helper_testdata_risk_structure": "图、树或复杂嵌套结构",
    "ai_helper_testdata_risk_subtasks": "子任务",
    "ai_helper_testdata_risk_tier_blocked": "已阻止",
    "ai_helper_testdata_risk_tier_high": "高",
    "ai_helper_testdata_risk_tier_low": "低",
    "ai_helper_testdata_risk_tier_medium": "中",
    "ai_helper_testdata_risk_title": "可靠性风险",
    "ai_helper_testdata_risk_unsupported_custom_checker": "不支持的自定义 checker",
    "ai_helper_testdata_risk_would_block": "本次运行发生了 enforce 模式会阻断的事件",
    "ai_helper_testdata_risk_yes": "是",
    ...
    "ai_helper_testdata_select_file": "选择写入 {0}",
    "ai_helper_testdata_semantic_coverage_actual": "实际",
    "ai_helper_testdata_semantic_coverage_fail": "未通过",
    "ai_helper_testdata_semantic_coverage_pass": "通过",
    "ai_helper_testdata_semantic_coverage_required": "要求",
    "ai_helper_testdata_semantic_coverage_status": "状态",
    "ai_helper_testdata_semantic_coverage_target": "目标",
    "ai_helper_testdata_semantic_coverage_target_all_equal": "全相等",
    "ai_helper_testdata_semantic_coverage_target_alternating": "交替取值",
    "ai_helper_testdata_semantic_coverage_target_graph_bridge": "含桥图",
    "ai_helper_testdata_semantic_coverage_target_graph_cycle": "含环图",
    "ai_helper_testdata_semantic_coverage_target_graph_dense": "稠密图",
    "ai_helper_testdata_semantic_coverage_target_graph_near_tree": "近树图",
    "ai_helper_testdata_semantic_coverage_target_graph_sparse": "稀疏图",
    "ai_helper_testdata_semantic_coverage_target_int32_max": "32 位最大边界",
    "ai_helper_testdata_semantic_coverage_target_int32_min": "32 位最小边界",
    "ai_helper_testdata_semantic_coverage_target_int64_max": "64 位最大边界",
    "ai_helper_testdata_semantic_coverage_target_int64_min": "64 位最小边界",
    "ai_helper_testdata_semantic_coverage_target_operation_add_delete_repeat": "重复增删",
    "ai_helper_testdata_semantic_coverage_target_operation_nested_lifetime": "嵌套生命周期",
    "ai_helper_testdata_semantic_coverage_target_operation_query_between_updates": "更新之间查询",
    "ai_helper_testdata_semantic_coverage_target_ordered": "有序序列",
    "ai_helper_testdata_semantic_coverage_target_reversed": "逆序序列",
    "ai_helper_testdata_semantic_coverage_target_size_max": "最大规模",
    "ai_helper_testdata_semantic_coverage_target_size_mid": "中等规模",
    "ai_helper_testdata_semantic_coverage_target_size_min": "最小规模",
    "ai_helper_testdata_semantic_coverage_target_subtask_membership": "子任务归属",
    "ai_helper_testdata_semantic_coverage_target_tree_balanced": "平衡树",
    "ai_helper_testdata_semantic_coverage_target_tree_broom": "扫帚树",
    "ai_helper_testdata_semantic_coverage_target_tree_chain": "链形树",
    "ai_helper_testdata_semantic_coverage_target_tree_star": "星形树",
    "ai_helper_testdata_semantic_coverage_target_value_max": "最大值",
    "ai_helper_testdata_semantic_coverage_target_value_min": "最小值",
    "ai_helper_testdata_semantic_coverage_title": "语义覆盖",
    "ai_helper_testdata_semantic_coverage_trusted": "已根据服务端结构化值验证",
    "ai_helper_testdata_semantic_coverage_unverified": "AI 生成器的语义覆盖未经验证",
    "ai_helper_testdata_skeleton_btn": "生成骨架文件（不调用 AI）",
    "ai_helper_testdata_skeleton_hint": "生成空白测试点与必要文件，需自行补全。",
    "ai_helper_testdata_spec_conflict_count": "冲突数量",
    "ai_helper_testdata_spec_consensus_status": "共识状态",
    "ai_helper_testdata_spec_consensus_status_adjudicated": "已裁决",
    "ai_helper_testdata_spec_consensus_status_consensus": "已达成共识",
    "ai_helper_testdata_spec_consensus_status_unresolved": "未解决",
    "ai_helper_testdata_spec_constraint_count": "约束数量",
    "ai_helper_testdata_spec_evidence_validated": "Evidence 校验通过",
    "ai_helper_testdata_spec_invariant_count": "不变量数量",
    "ai_helper_testdata_spec_no": "否",
    "ai_helper_testdata_spec_roles_used": "已使用模型角色",
    "ai_helper_testdata_spec_schema_version": "Spec schema version",
    "ai_helper_testdata_spec_statement_hash": "题面 hash",
    "ai_helper_testdata_spec_summary_title": "题意规范摘要",
    "ai_helper_testdata_spec_unavailable": "不可用",
    "ai_helper_testdata_spec_uncertainty_count": "未解决 uncertainty 数量",
    "ai_helper_testdata_spec_unresolved_conflict_count": "未解决冲突数量",
    "ai_helper_testdata_spec_yes": "是",
    ...
    "ai_helper_testdata_std_hint": "已有正确解法可粘贴在此，用于计算答案；留空由 AI 编写。",
    ...
    "ai_helper_testdata_step_components": "准备生成组件",
    "ai_helper_testdata_step_finish": "整理结果",
    "ai_helper_testdata_step_inputs": "生成并检查数据",
    "ai_helper_testdata_step_understand": "理解题目",
    "ai_helper_testdata_step_verify": "独立验证",
    "ai_helper_testdata_strong_model_notice": "建议使用擅长代码推理的模型。生成可能耗时数分钟，并产生模型费用。",
    "ai_helper_testdata_subtask_label": "子任务 {0}",
    ...
    "ai_helper_testdata_verify_checker": "自定义 checker",
    "ai_helper_testdata_verify_checker_configured": "已配置",
    "ai_helper_testdata_verify_checker_executed": "题目 testlib checker 已编译并用于实际判定",
    "ai_helper_testdata_verify_checker_fallback": "Checker 验证失败，本结果未通过验证",
    "ai_helper_testdata_verify_checker_read": "已读取 checker 源码",
    "ai_helper_testdata_verify_checker_runtime_skipped": "{0} 次 checker 判定因沙箱基础设施错误跳过",
    "ai_helper_testdata_verify_compiled": "已编译",
    "ai_helper_testdata_verify_evidence": "硬验证证据",
    "ai_helper_testdata_verify_executed": "已执行",
    "ai_helper_testdata_verify_failure": "失败原因",
    "ai_helper_testdata_verify_failure_budget": "超出预算",
    "ai_helper_testdata_verify_failure_checker_infra": "checker 基础设施异常",
    "ai_helper_testdata_verify_failure_compile": "编译失败",
    "ai_helper_testdata_verify_failure_infra": "基础设施异常",
    "ai_helper_testdata_verify_failure_mismatch": "输出不一致",
    "ai_helper_testdata_verify_failure_reject": "判定未通过",
    "ai_helper_testdata_verify_failure_runtime": "运行失败",
    "ai_helper_testdata_verify_failure_unavailable": "不可用",
    "ai_helper_testdata_verify_infra_failures": "基础设施失败",
    ...
    "ai_helper_testdata_verify_no": "否",
    "ai_helper_testdata_verify_passed": "通过",
    "ai_helper_testdata_verify_samples": "题面样例回归",
    "ai_helper_testdata_verify_status_unverified": "未验证",
    "ai_helper_testdata_verify_status_verified": "已验证",
    "ai_helper_testdata_verify_status_would_block": "强制模式下将阻断",
    ...
    "ai_helper_testdata_verify_validator_coverage": "约束覆盖",
    "ai_helper_testdata_verify_validator_invalid_accepted": "非法输入误接受",
    "ai_helper_testdata_verify_validator_invalid_rejected": "非法输入已拒绝",
    "ai_helper_testdata_verify_validator_legal": "合法输入已接受",
    "ai_helper_testdata_verify_validator_none": "未提供校验器",
    "ai_helper_testdata_verify_yes": "是",
    ...
    "ai_helper_update_deps_reinstall_failed": "警告：依赖包重装失败，服务可能无法正常启动",
    ...
    "ai_helper_update_dist_rebuild_failed": "警告：dist 重建失败，服务可能无法正常启动",
    ...
    "ai_helper_update_no_backup_cannot_rollback": "未能获取更新前的备份 commit，无法安全回滚。为保护当前版本，已中止更新且不会修改本地代码。",
    ...
    "ai_helper_update_pubkey_file_missing": "未找到发布者公钥文件（assets/trusted-keys/publisher.asc）。当前使用隔离的 GNUPGHOME，无法从系统密钥环继承公钥，签名验证可能失败；请修复公钥文件后重试。",
  ...
  "en": {
    ...
    "ai_helper_admin_model_down": "Move down",
    "ai_helper_admin_model_remove": "Remove",
    "ai_helper_admin_model_up": "Move up",
    ...
    "ai_helper_admin_scenario_desc": "Features use the global models by default. Override a feature only when needed; models run in the listed order.",
    ...
    "ai_helper_admin_scenario_testdata_strong_model_warning": "Model selection: start with a reliable code-reasoning model and optionally add a stronger fallback for harder problems.",
    ...
    "ai_helper_admin_testdata_recommend_flash": "Suggested: DeepSeek Flash",
    "ai_helper_admin_testdata_recommend_flash_fallback": "Suggested: Flash, then Pro",
    "ai_helper_admin_testdata_recommend_pro": "Suggested: DeepSeek Pro",
    "ai_helper_admin_testdata_role_add_model": "Add model…",
    "ai_helper_admin_testdata_role_adjudicator": "Adjudicator",
    "ai_helper_admin_testdata_role_adjudicator_purpose": "Resolve conflicts between the two specs using evidence from the statement.",
    "ai_helper_admin_testdata_role_artifacts": "Generator and supporting files",
    "ai_helper_admin_testdata_role_artifacts_purpose": "Write input generators or generation plans, plus function-problem templates; try Flash with Pro as fallback.",
    "ai_helper_admin_testdata_role_configure": "Configure",
    "ai_helper_admin_testdata_role_inherited": "Following Test Data Generation",
    "ai_helper_admin_testdata_role_no_model": "No model configured",
    "ai_helper_admin_testdata_role_oracle": "Oracle",
    "ai_helper_admin_testdata_role_oracle_purpose": "Write the program that computes correct answers; requires algorithm and code reasoning.",
    "ai_helper_admin_testdata_role_reset": "Reset to Test Data Generation",
    "ai_helper_admin_testdata_role_spec_critic": "Spec Critic",
    "ai_helper_admin_testdata_role_spec_critic_purpose": "Independently review the statement. Use different models from the primary parser, including fallbacks.",
    "ai_helper_admin_testdata_role_spec_primary": "Spec Primary",
    "ai_helper_admin_testdata_role_spec_primary_purpose": "Extract input formats, constraints and boundaries; requires reliable statement comprehension.",
    "ai_helper_admin_testdata_role_verifier": "Verifier",
    "ai_helper_admin_testdata_role_verifier_purpose": "Independently check answers and inputs. Use different models from the oracle, including fallbacks.",
    "ai_helper_admin_testdata_roles_desc": "Stages inherit the test data model by default. Open a stage to edit its models, tried in order. Treat these suggestions as a starting point and test with known answers.",
    "ai_helper_admin_testdata_roles_title": "Models by stage (advanced)",
    ...
    "ai_helper_batch_summary_action_failed": "Action could not be completed. Please retry.",
    "ai_helper_batch_summary_awaiting_review": "Drafts to review",
    ...
    "ai_helper_batch_summary_generated_count": "Generated {0} / {1} summaries",
    "ai_helper_batch_summary_generating": "Generating AI summaries...",
    "ai_helper_batch_summary_loading": "Loading...",
    "ai_helper_batch_summary_more_actions": "More generation actions",
    ...
    "ai_helper_batch_summary_remaining_count": "{0} awaiting generation",
    ...
    "ai_helper_next_page": "Next page",
    "ai_helper_previous_page": "Previous page",
    ...
    "ai_helper_teaching_summary_collapse": "Collapse",
    "ai_helper_teaching_summary_copy_student": "Copy student version",
    "ai_helper_teaching_summary_evidence_label": "Evidence",
    "ai_helper_teaching_summary_evidence_title": "View evidence and students",
    "ai_helper_teaching_summary_failure_hint": "A complete analysis was not received. Please try again later.",
    "ai_helper_teaching_summary_failure_title": "Teaching analysis could not be completed",
    "ai_helper_teaching_summary_focus_hint": "Generated from this activity’s data. Check possible causes against classroom observations.",
    "ai_helper_teaching_summary_focus_title": "Teaching focus",
    "ai_helper_teaching_summary_high_priority": "Priority attention",
    "ai_helper_teaching_summary_homework_audience": "Practice version",
    "ai_helper_teaching_summary_homework_student": "Student practice",
    "ai_helper_teaching_summary_homework_teacher": "Teacher reference",
    "ai_helper_teaching_summary_homework_unrecognized": "This document’s student and teacher sections could not be separated reliably. Review the teacher reference and prepare the student copy manually.",
    "ai_helper_teaching_summary_individual_support": "Individual support",
    "ai_helper_teaching_summary_priority_attention": "Review first",
    "ai_helper_teaching_summary_retry": "Retry generation",
    "ai_helper_teaching_summary_retry_hint": "You can try generating again. If this keeps failing, ask an administrator to check the AI service.",
    "ai_helper_teaching_summary_section_homework": "Follow-up practice",
    "ai_helper_teaching_summary_section_review": "Next class actions",
    "ai_helper_teaching_summary_student_hint": "Includes the exercise code and follow-up questions. Copies exactly the student version below.",
    "ai_helper_teaching_summary_teacher_hint": "Includes teaching notes and reference answers. “Copy student version” copies only student practice.",
    "ai_helper_teaching_summary_view_details": "View details",
    "ai_helper_teaching_summary_view_teacher": "View teacher reference",
    "ai_helper_testdata_apply_btn": "Write to problem ({0} files)",
    ...
    "ai_helper_testdata_background_active": "Running in the background — you can leave this page; progress and results are restored when you return.",
    ...
    "ai_helper_testdata_coverage_case": "Case {0}",
    "ai_helper_testdata_coverage_plan_hint": "These are planned cases. Check them against the actual file contents.",
    "ai_helper_testdata_coverage_scale_large": "Near limit",
    "ai_helper_testdata_coverage_scale_medium": "Medium",
    "ai_helper_testdata_coverage_scale_small": "Small",
    "ai_helper_testdata_coverage_title": "Test coverage plan",
    ...
    "ai_helper_testdata_direct_confirmation_action": "Confirm unverified direct generation",
    "ai_helper_testdata_direct_confirmation_required": "Unverified direct generation is available only after a second confirmation for this medium-risk task.",
    "ai_helper_testdata_discard_btn": "Discard this result",
    "ai_helper_testdata_discard_confirm": "Discard this generated result? No files will be written.",
    "ai_helper_testdata_discrimination_summary": "Discrimination check: {0}/{1} targets killed",
    "ai_helper_testdata_discrimination_warning": "Some targets survived or could not be checked; review the generation notes",
    "ai_helper_testdata_edit_file": "Edit {0}",
    ...
    "ai_helper_testdata_err_config_unparsable": "The existing config.yaml cannot be parsed. Generation was stopped to avoid overwriting and losing its settings; fix or delete the file, then retry.",
    "ai_helper_testdata_err_cpp_oracle_infra": "The C++ compilation infrastructure is temporarily unavailable, so the teacher-provided C++ reference solution cannot be executed. Retry later or check the sandbox service.",
    "ai_helper_testdata_err_cpp_oracle_unavailable": "The current sandbox has no C++ compiler available, so the teacher-provided C++ reference solution cannot be used. Check the g++ setup or provide a Python solution.",
    "ai_helper_testdata_err_cpp_std_compile_failed": "The teacher-provided C++ reference solution failed to compile. g++ error summary:",
    ...
    "ai_helper_testdata_err_file_too_large": "File limit exceeded: inputs, outputs and replay data allow 4 MiB; code allows 256 KiB",
    ...
    "ai_helper_testdata_err_total_too_large": "Total file size exceeds 8 MiB",
    ...
    "ai_helper_testdata_failure_brute_runtime_failed": "The independent brute-force solution failed at runtime.",
    "ai_helper_testdata_failure_brute_timeout": "The independent brute-force solution timed out on small data.",
    "ai_helper_testdata_failure_cancelled": "Generation was canceled. Model requests already sent may still incur charges.",
    "ai_helper_testdata_failure_checker_compile_failed": "The problem checker failed to compile.",
    "ai_helper_testdata_failure_checker_required_unavailable": "This problem requires checker validation, but the checker is unavailable.",
    "ai_helper_testdata_failure_checker_runtime_failed": "The problem checker failed at runtime or its infrastructure was unavailable.",
    "ai_helper_testdata_failure_coverage_requirement_missing": "The generated tests do not meet a required coverage condition.",
    "ai_helper_testdata_failure_direct_fallback_confirmation_required": "This medium-risk task needs a second teacher confirmation before unverified direct generation.",
    "ai_helper_testdata_failure_generator_invalid_input": "The input generator produced invalid test input.",
    "ai_helper_testdata_failure_generator_invalid_json": "The input generator returned an invalid data format.",
    "ai_helper_testdata_failure_generator_output_too_large": "The input generator output exceeded the safety limit.",
    "ai_helper_testdata_failure_generator_wrong_case_count": "The input generator returned the wrong number of test cases.",
    "ai_helper_testdata_failure_mutation_score_too_low": "The generated tests do not distinguish enough representative wrong solutions.",
    "ai_helper_testdata_failure_oracle_brute_divergence": "The reference solution and independent brute-force solution disagree. Automatic repair stopped for adjudication.",
    "ai_helper_testdata_failure_oracle_compile_failed": "The reference solution failed to compile, so machine verification cannot continue.",
    "ai_helper_testdata_failure_oracle_runtime_failed": "The reference solution failed at runtime, so reliable outputs cannot be generated.",
    "ai_helper_testdata_failure_oracle_sample_mismatch": "The reference solution did not pass the statement samples.",
    "ai_helper_testdata_failure_pipeline_budget_exhausted": "Machine verification reached its total time budget. Reduce the case count or data scale and retry.",
    "ai_helper_testdata_failure_sandbox_required": "This generation task requires Hydro sandbox verification.",
    "ai_helper_testdata_failure_sandbox_unavailable": "The Hydro sandbox is unavailable. Retry later or check its configuration.",
    "ai_helper_testdata_failure_spec_conflict": "The problem analyses conflict and require adjudication.",
    "ai_helper_testdata_failure_spec_consensus_required": "The problem interpretation has not reached reliable consensus.",
    "ai_helper_testdata_failure_spec_evidence_not_found": "The analysis lacks verifiable statement evidence, so generation stopped.",
    "ai_helper_testdata_failure_spec_parse_failed": "The problem specification could not be parsed. Retry or check the statement format.",
    "ai_helper_testdata_failure_spec_statement_too_long": "The statement is too long to parse safely. Shorten it or retry later.",
    "ai_helper_testdata_failure_spec_statement_truncated": "The full statement was not processed, so generation stopped to avoid missing constraints.",
    "ai_helper_testdata_failure_stress_insufficient_valid_inputs": "Too few stress inputs passed validation for reliable differential testing.",
    "ai_helper_testdata_failure_stress_low_diversity": "The stress inputs contain too many duplicates for effective validation.",
    "ai_helper_testdata_failure_subtask_constraint_violation": "Generated data violates a subtask constraint.",
    "ai_helper_testdata_failure_template_compile_failed": "A judge template failed to compile.",
    "ai_helper_testdata_failure_template_output_mismatch": "A judge template output disagrees with the reference solution.",
    "ai_helper_testdata_failure_template_runtime_failed": "A judge template failed at runtime.",
    "ai_helper_testdata_failure_trusted_solutions_diverged": "A candidate reference solution conflicts with independent verification and was rejected.",
    "ai_helper_testdata_failure_unknown": "Test-data generation did not pass machine verification. Retry or use skeleton mode.",
    "ai_helper_testdata_failure_validator_constraint_coverage_missing": "The validator does not cover all required constraints.",
    "ai_helper_testdata_failure_validator_false_accept": "The validator accepted invalid data and must be corrected.",
    "ai_helper_testdata_failure_validator_false_reject": "The validator rejected data needed for verification; the validator or generator must be corrected.",
    ...
    "ai_helper_testdata_files_title": "Review and edit files",
    ...
    "ai_helper_testdata_fill_in_hint": "Answers follow the output format of the incomplete code in the statement.",
    ...
    "ai_helper_testdata_generating_hint": "Complex problems may take several minutes or longer, and model calls keep accruing cost while it runs; you can cancel at any time.",
    "ai_helper_testdata_job_failed": "The background generation task failed. Please try again.",
    "ai_helper_testdata_job_interrupted": "The generation service restarted or lost its worker during this task. You can resume from its saved checkpoint; if the settings or statement changed, a fresh generation starts automatically.",
    ...
    "ai_helper_testdata_kill_targets_capped_warning": "The model returned {0} kill targets; the server kept only the first {1}.",
    ...
    "ai_helper_testdata_kind_hint": "Function problems include judging templates. Describe any special input formats in the extra requirements.",
    "ai_helper_testdata_kind_input": "Test input",
    "ai_helper_testdata_kind_label": "Problem type",
    "ai_helper_testdata_kind_output": "Expected output",
    ...
    "ai_helper_testdata_languages_hint": "Choose supported languages for function problems.",
    "ai_helper_testdata_languages_label": "Template languages",
    "ai_helper_testdata_manual_review_suggestion": "This failure needs manual adjudication or review. Inspect the conflicting artifacts and sandbox evidence before continuing.",
    ...
    "ai_helper_testdata_mutation_operator_arithmetic_operator": "Arithmetic operator",
    ...
    "ai_helper_testdata_mutation_operator_equality_negation": "Equality negation",
    "ai_helper_testdata_mutation_operator_historical_submission": "Historical submission",
    "ai_helper_testdata_mutation_operator_logical_connector": "Logical connector",
    "ai_helper_testdata_mutation_operators": "Operators",
    "ai_helper_testdata_mutation_skip_budget_exhausted": "Budget exhausted",
    "ai_helper_testdata_mutation_skip_checker_infra": "Checker infrastructure unavailable",
    "ai_helper_testdata_mutation_skip_gate_off": "Gate disabled",
    "ai_helper_testdata_mutation_skip_no_candidates": "No candidates",
    "ai_helper_testdata_mutation_skip_no_viable_candidates": "No viable candidates",
    "ai_helper_testdata_mutation_skip_reason": "Reason",
    "ai_helper_testdata_mutation_skip_sandbox_infra": "Sandbox infrastructure unavailable",
    "ai_helper_testdata_mutation_skip_sandbox_unavailable": "Sandbox unavailable",
    "ai_helper_testdata_mutation_skip_unsupported_source": "Unsupported source language",
    ...
    "ai_helper_testdata_notes_ai_toggle": "AI-generated notes (click to expand)",
    "ai_helper_testdata_notes_system_title": "Verification notes",
    "ai_helper_testdata_notes_warnings_title": "Needs attention",
    "ai_helper_testdata_outcome_already_recorded": "A final outcome has already been recorded for this result",
    "ai_helper_testdata_outcome_invalid_reason": "The discard reason is invalid",
    ...
    "ai_helper_testdata_panel_subtitle": "Generate test data from the statement. Review it before writing to the problem.",
    "ai_helper_testdata_panel_title": "AI Test Data Generation",
    "ai_helper_testdata_progress_artifacts": "Generating the data generator and independent checking components",
    ...
    "ai_helper_testdata_progress_blueprint": "Analyzing the problem and designing a solution",
    "ai_helper_testdata_progress_blueprint_repair": "Fixing the solution output format",
    ...
    "ai_helper_testdata_progress_discrimination_testing": "Checking that the data catches typical wrong solutions",
    ...
    "ai_helper_testdata_progress_heartbeat": "Running in the background · responded {0}s ago",
    "ai_helper_testdata_progress_heartbeat_stale": "The background task has not responded recently; this page keeps checking. Please do not start a duplicate task.",
    "ai_helper_testdata_progress_independent_verifier": "AI is independently generating the brute solver and stress data",
    "ai_helper_testdata_progress_last_update": "Last progress update {0}:{1} ago",
    "ai_helper_testdata_progress_live": "Actual execution stage",
    ...
    "ai_helper_testdata_progress_mutation_testing": "Running mutation-based discrimination checks",
    ...
    "ai_helper_testdata_progress_rework_notice": "A problem was found during verification and is being fixed; affected steps will run again afterwards.",
    ...
    "ai_helper_testdata_progress_solution_verification": "Pre-checking the reference solution against the statement samples",
    ...
    "ai_helper_testdata_progress_waiting_long": "This stage is taking a while, but the task is still running. You can keep waiting or cancel at any time.",
    "ai_helper_testdata_refresh_btn": "Refresh page",
    "ai_helper_testdata_regenerate_btn": "Regenerate",
    "ai_helper_testdata_result_checked": "Automated checks completed",
    "ai_helper_testdata_result_not_written": "Not yet written to the problem",
    "ai_helper_testdata_result_partly_written": "Some files are already written; review before writing again",
    "ai_helper_testdata_result_review": "Review before writing",
    "ai_helper_testdata_result_review_answers": "Answer checks found a mismatch. Correct it before writing.",
    "ai_helper_testdata_result_review_config": "Check every case’s subtask assignment and score in config.yaml. Cases outside all subtasks will not be judged.",
    "ai_helper_testdata_result_review_coverage": "Some key boundaries lack coverage. Add the corresponding test cases.",
    "ai_helper_testdata_result_review_direct": "Answers have not been verified by execution. Check them with a correct solution first.",
    "ai_helper_testdata_result_review_files": "Template or checker checks failed. Correct the files before writing.",
    "ai_helper_testdata_result_review_incomplete": "Some checks failed or are incomplete. Review the statement and key test cases.",
    "ai_helper_testdata_result_review_inputs": "Input checks are incomplete or found an issue. Confirm that inputs meet the problem constraints.",
    "ai_helper_testdata_result_review_next": "Spot-check inputs and answers, then submit a correct solution after writing to test the problem again.",
    "ai_helper_testdata_result_review_skeleton": "Fill in each input and answer. Empty files are not ready for judging.",
    "ai_helper_testdata_result_review_skeleton_function": "Fill in inputs and answers, and complete template TODOs before writing.",
    "ai_helper_testdata_result_review_statement": "The statement interpretation is unresolved. Check input requirements and answer rules.",
    "ai_helper_testdata_result_skeleton_title": "Prepared {0} empty test cases",
    "ai_helper_testdata_result_title": "Generated {0} test cases",
    "ai_helper_testdata_resume_checkpoint_btn": "Resume from checkpoint",
    "ai_helper_testdata_retry_btn": "Retry",
    "ai_helper_testdata_retry_suggestion": "The failed artifact can be repaired. Review the error and retry generation.",
    ...
    "ai_helper_testdata_risk_complex_structure": "Complex nested structure",
    "ai_helper_testdata_risk_counted_test_cases": "Counted multiple test cases",
    "ai_helper_testdata_risk_custom_checker": "Custom checker",
    "ai_helper_testdata_risk_direct_allowed": "Direct fallback allowed",
    "ai_helper_testdata_risk_floating_point": "Floating-point output",
    "ai_helper_testdata_risk_graph_or_tree": "Graph or tree structure",
    "ai_helper_testdata_risk_mode": "Reliability mode",
    "ai_helper_testdata_risk_multiple_guarantees_or_conventions": "Multiple guarantees or conventions",
    "ai_helper_testdata_risk_multiple_valid_output": "Multiple valid outputs",
    "ai_helper_testdata_risk_no": "No",
    "ai_helper_testdata_risk_no_parseable_samples": "No parseable sample pair",
    "ai_helper_testdata_risk_requires_consensus": "Requires spec consensus",
    "ai_helper_testdata_risk_requires_independent_models": "Requires independent models",
    "ai_helper_testdata_risk_requires_sandbox": "Sandbox required",
    "ai_helper_testdata_risk_spec_conflict": "Problem specification conflict",
    "ai_helper_testdata_risk_stateful_operations": "State-changing operations",
    "ai_helper_testdata_risk_statement_too_long": "Statement exceeds the safe review threshold",
    "ai_helper_testdata_risk_structure": "Graph, tree, or complex nested structure",
    "ai_helper_testdata_risk_subtasks": "Subtasks",
    "ai_helper_testdata_risk_tier_blocked": "Blocked",
    "ai_helper_testdata_risk_tier_high": "High",
    "ai_helper_testdata_risk_tier_low": "Low",
    "ai_helper_testdata_risk_tier_medium": "Medium",
    "ai_helper_testdata_risk_title": "Reliability risk",
    "ai_helper_testdata_risk_unsupported_custom_checker": "Unsupported custom checker",
    "ai_helper_testdata_risk_would_block": "This run encountered an event that enforce mode would block",
    ...
    "ai_helper_testdata_select_file": "Select {0} for writing",
    ...
    "ai_helper_testdata_semantic_coverage_target_all_equal": "All values equal",
    "ai_helper_testdata_semantic_coverage_target_alternating": "Alternating values",
    "ai_helper_testdata_semantic_coverage_target_graph_bridge": "Graph with bridge",
    "ai_helper_testdata_semantic_coverage_target_graph_cycle": "Graph with cycle",
    "ai_helper_testdata_semantic_coverage_target_graph_dense": "Dense graph",
    "ai_helper_testdata_semantic_coverage_target_graph_near_tree": "Near-tree graph",
    "ai_helper_testdata_semantic_coverage_target_graph_sparse": "Sparse graph",
    "ai_helper_testdata_semantic_coverage_target_int32_max": "32-bit maximum",
    "ai_helper_testdata_semantic_coverage_target_int32_min": "32-bit minimum",
    "ai_helper_testdata_semantic_coverage_target_int64_max": "64-bit maximum",
    "ai_helper_testdata_semantic_coverage_target_int64_min": "64-bit minimum",
    "ai_helper_testdata_semantic_coverage_target_operation_add_delete_repeat": "Repeated add/delete",
    "ai_helper_testdata_semantic_coverage_target_operation_nested_lifetime": "Nested lifetimes",
    "ai_helper_testdata_semantic_coverage_target_operation_query_between_updates": "Query between updates",
    "ai_helper_testdata_semantic_coverage_target_ordered": "Ordered sequence",
    "ai_helper_testdata_semantic_coverage_target_reversed": "Reversed sequence",
    "ai_helper_testdata_semantic_coverage_target_size_max": "Maximum size",
    "ai_helper_testdata_semantic_coverage_target_size_mid": "Mid-range size",
    "ai_helper_testdata_semantic_coverage_target_size_min": "Minimum size",
    "ai_helper_testdata_semantic_coverage_target_subtask_membership": "Subtask membership",
    "ai_helper_testdata_semantic_coverage_target_tree_balanced": "Balanced tree",
    "ai_helper_testdata_semantic_coverage_target_tree_broom": "Broom tree",
    "ai_helper_testdata_semantic_coverage_target_tree_chain": "Chain tree",
    "ai_helper_testdata_semantic_coverage_target_tree_star": "Star tree",
    "ai_helper_testdata_semantic_coverage_target_value_max": "Maximum value",
    "ai_helper_testdata_semantic_coverage_target_value_min": "Minimum value",
    ...
    "ai_helper_testdata_skeleton_hint": "Create empty cases and supporting files for you to complete.",
    "ai_helper_testdata_spec_conflict_count": "Conflict count",
    "ai_helper_testdata_spec_consensus_status": "Consensus status",
    "ai_helper_testdata_spec_consensus_status_adjudicated": "Adjudicated",
    "ai_helper_testdata_spec_consensus_status_consensus": "Consensus",
    "ai_helper_testdata_spec_consensus_status_unresolved": "Unresolved",
    "ai_helper_testdata_spec_constraint_count": "Constraint count",
    "ai_helper_testdata_spec_evidence_validated": "Evidence validated",
    "ai_helper_testdata_spec_invariant_count": "Invariant count",
    "ai_helper_testdata_spec_no": "No",
    "ai_helper_testdata_spec_roles_used": "Model roles used",
    "ai_helper_testdata_spec_schema_version": "Spec schema version",
    ...
    "ai_helper_testdata_spec_uncertainty_count": "Unresolved uncertainty count",
    "ai_helper_testdata_spec_unresolved_conflict_count": "Unresolved conflict count",
    ...
    "ai_helper_testdata_std_hint": "Paste a known correct solution to calculate answers, or leave blank for AI to write one.",
    ...
    "ai_helper_testdata_step_components": "Prepare components",
    "ai_helper_testdata_step_finish": "Assemble results",
    "ai_helper_testdata_step_inputs": "Generate and check data",
    "ai_helper_testdata_step_understand": "Understand problem",
    "ai_helper_testdata_step_verify": "Independent verification",
    "ai_helper_testdata_strong_model_notice": "Use a model with strong code reasoning. Generation can take several minutes and incur model charges.",
    ...
    "ai_helper_testdata_verify_checker": "Custom checker",
    "ai_helper_testdata_verify_checker_configured": "Configured",
    "ai_helper_testdata_verify_checker_executed": "The problem's testlib checker was compiled and used for actual judgments",
    "ai_helper_testdata_verify_checker_fallback": "Checker verification failed; this result is not verified",
    "ai_helper_testdata_verify_checker_read": "Checker source read",
    "ai_helper_testdata_verify_checker_runtime_skipped": "{0} checker judgments skipped due to sandbox infrastructure errors",
    ...
    "ai_helper_testdata_verify_failure": "Failure reason",
    "ai_helper_testdata_verify_failure_budget": "budget",
    "ai_helper_testdata_verify_failure_checker_infra": "checker infrastructure",
    "ai_helper_testdata_verify_failure_compile": "compile",
    "ai_helper_testdata_verify_failure_infra": "infrastructure",
    "ai_helper_testdata_verify_failure_mismatch": "output mismatch",
    "ai_helper_testdata_verify_failure_reject": "rejected",
    "ai_helper_testdata_verify_failure_runtime": "runtime",
    "ai_helper_testdata_verify_failure_unavailable": "unavailable",
    ...
    "ai_helper_testdata_verify_status_would_block": "Would block in enforce mode",
