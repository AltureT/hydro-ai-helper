...
export const LOCALE_FALLBACK: Record<'zh' | 'en', Record<string, string>> = {
  "zh": {
    ...
    "ai_helper_admin_testdata_role_add_model": "向角色链添加模型",
    "ai_helper_admin_testdata_role_adjudicator": "冲突裁决",
    "ai_helper_admin_testdata_role_artifacts": "外围制品",
    "ai_helper_admin_testdata_role_inherited": "已继承",
    ...
    "ai_helper_admin_testdata_roles_desc": "可为测试数据各阶段单独配置模型链；留空时继承测试数据场景模型链。",
    "ai_helper_admin_testdata_roles_title": "高级角色模型",
  ...
  "en": {
    ...
    "ai_helper_admin_testdata_role_add_model": "Add model to role chain",
    "ai_helper_admin_testdata_role_adjudicator": "Adjudicator",
    "ai_helper_admin_testdata_role_artifacts": "Artifacts",
    "ai_helper_admin_testdata_role_inherited": "Inherited",
    ...
    "ai_helper_admin_testdata_roles_desc": "Optionally assign independent model chains to each test-data stage. Empty roles inherit the test-data scenario chain.",
    "ai_helper_admin_testdata_roles_title": "Advanced role models",
