...
- **AI Test Data Generation** — generate a full test data set from the statement on the problem files page (`/p/:pid/files`)
  ...
  - Offers Standard (about 15 minutes) and Hard Problem (up to about 90 minutes) modes. Jobs keep running on the server after the page is closed or left; returning to the problem files page restores progress or results, with cancellation available across page visits
