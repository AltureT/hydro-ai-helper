...
> **🚨 重要升级公告（2026-02-01）**
> v1.8.5 已发布，修复了统计上报 bug（v1.8.4 存在双斜杠 URL 错误导致数据无法上报）。
> **所有用户请立即升级**：`hydrooj addon add hydro-ai-helper@latest && pm2 restart hydro`
> 详见 [升级指南](UPGRADE-v1.8.5.md) | [Release Notes](https://github.com/AltureT/hydro-ai-helper/releases/tag/v1.8.5)
