 ...
 */
export function normalizeGenerationObject(obj: Record<string, unknown>, options: GenerateOptions): GenerationResponse {
...
export function parseGenerationResponse(raw: string, options: GenerateOptions): GenerationResponse {
  ...
  return normalizeGenerationObject(parsed as Record<string, unknown>, options);
}
 ...
 */
export function parseDelimitedResponse(raw: string, options: GenerateOptions): GenerationResponse | null {
 ...
 */
export function parseAiResponse(raw: string, options: GenerateOptions): GenerationResponse {
