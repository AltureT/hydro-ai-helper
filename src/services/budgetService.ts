...
export class BudgetService {
  constructor(private tokenUsageModel: TokenUsageModel) {}

  async checkBudget(domainId: string, userId: number, budgetConfig: BudgetConfig): Promise<BudgetCheckResult> {
