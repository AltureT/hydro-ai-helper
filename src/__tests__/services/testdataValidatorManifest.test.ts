...
describe('validator probe recipe', () => {
  ...
  it.each([
    ...
    ['subtask alias', '{"recipes":[{"targetId":"I1","constructionKind":"duplicate-element","subtask":1}]}'],
    ['seed index', '{"recipes":[{"targetId":"I1","constructionKind":"duplicate-element","seedIndex":1}]}'],
    ['seed alias', '{"recipes":[{"targetId":"I1","constructionKind":"duplicate-element","seed":1}]}'],
